...
void DR_BaudRateSet()
{
  switch(DATA_BAUD_RATE)
  {
    case 0:
      DXL_BaudRateSet(2000000);
      break;
    case 1:
      DXL_BaudRateSet(1000000);
      break;
    case 2:
      DXL_BaudRateSet(666666);
      break;
    case 3:
      DXL_BaudRateSet(500000);
      break;
    case 4:
      DXL_BaudRateSet(400000);
      break;
  }
}
